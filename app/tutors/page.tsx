...
import { MapPin, Clock, GraduationCap, ArrowRight, Users, UserCheck, Star } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
                    {tutors.map((tutor, index) => (
                        <motion.div
                            ...
                            className="bg-white rounded-2xl overflow-hidden shadow-lg shadow-slate-100/50 border border-slate-100 hover:shadow-xl hover:border-emerald-100 transition-all group"
                        >
                            <Link href={`/tutors/${tutor.slug}`} className="block h-full">
                                ...
                                <div className="p-4">
                                    {/* Name & Location */}
                                    <div className="mb-3">
                                        <h2 className="text-lg font-bold text-slate-800 leading-tight mb-1 group-hover:text-emerald-600 transition-colors">{tutor.nama}</h2>
