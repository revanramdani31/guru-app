            ...
            <section className="relative bg-emerald-600 text-white overflow-hidden py-28">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-emerald-50/90 leading-relaxed font-medium drop-shadow-sm">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <p className="text-slate-600">
                            Menjadi platform pendidikan privat terdepan di Indonesia yang mencetak generasi unggul, berkarakter, dan berdaya saing global.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <ul className="space-y-3 text-slate-600 text-sm">
                            <li className="flex items-start gap-2">
                                ...
                                <span>Menyediakan akses ke tutor berkualitas tinggi dari universitas terbaik.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2" />
                                <span>Menerapkan personalisasi metode belajar berbasis data.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2" />
