                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
                        ...
                        <Link href="/biaya" className="w-full sm:w-auto">
                            <button className="w-full sm:w-auto inline-flex items-center justify-center bg-emerald-700 hover:bg-emerald-800 text-white px-8 py-4 text-lg rounded-xl font-semibold transition-all border border-emerald-600 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
